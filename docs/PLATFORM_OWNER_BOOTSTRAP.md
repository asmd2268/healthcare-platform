...
العملية idempotent ولا تعتمد على البريد الإلكتروني ولا يوجد فيها معرف مستخدم حقيقي في المستودع. لا توجد route عامة لتنفيذها، ولا يجب استخدام Service Role Key في المتصفح.
