...
export function PlatformShell({children}: {children: React.ReactNode}) {
  ...
  const nav = [['', 'nav.home'], ['inspections', 'inspections.nav'], ['medication-errors', 'medicationErrors.nav'], ['policies', 'policies.nav'], ['capa', 'capa.nav'], ['settings', 'nav.settings'], ['profile', 'nav.profile'], ['audit', 'nav.audit']] as const;
